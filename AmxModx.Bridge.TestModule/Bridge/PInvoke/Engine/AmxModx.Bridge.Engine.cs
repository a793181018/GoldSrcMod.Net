...
namespace AmxModx.Bridge.Engine
{
    ...
    public static class EngineBridge
    {
        ...
        [DllImport(EngineBridgeDll, CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr Engine_GetString(int stringId);
        ...
        [DllImport(EngineBridgeDll, CallingConvention = CallingConvention.Cdecl)]
        public static extern int Engine_AllocString(string text);
        ...
        /// <returns>注册ID</returns>
        [DllImport(EngineBridgeDll, CallingConvention = CallingConvention.Cdecl)]
        public static extern int RegisterImpulse(int impulse, ImpulseCallback callback);
        ...
        /// <returns>注册ID</returns>
        [DllImport(EngineBridgeDll, CallingConvention = CallingConvention.Cdecl)]
        public static extern int RegisterTouch(string touchedClass, string toucherClass, TouchCallback callback);
        ...
        /// <returns>注册ID</returns>
        [DllImport(EngineBridgeDll, CallingConvention = CallingConvention.Cdecl)]
        public static extern int RegisterThink(string className, ThinkCallback callback);
        ...
        /// <returns>成功返回1，失败返回0</returns>
        [DllImport(EngineBridgeDll, CallingConvention = CallingConvention.Cdecl)]
        public static extern int UnregisterImpulse(int registerId);
        ...
        /// <returns>成功返回1，失败返回0</returns>
        [DllImport(EngineBridgeDll, CallingConvention = CallingConvention.Cdecl)]
        public static extern int UnregisterTouch(int registerId);
        ...
        /// <returns>成功返回1，失败返回0</returns>
        [DllImport(EngineBridgeDll, CallingConvention = CallingConvention.Cdecl)]
        public static extern int UnregisterThink(int registerId);
