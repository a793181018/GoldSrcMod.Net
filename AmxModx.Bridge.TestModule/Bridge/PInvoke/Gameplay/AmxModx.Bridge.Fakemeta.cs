...
namespace AmxModx.Bridge.Fakemeta
{
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    public struct FMB_EventData
    {
        public int entityIndex;
        public int playerIndex;
        public float floatParam;
        public int intParam;
        public IntPtr stringParam;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
        public float[] vectorParam;
    ...
    public static class ForwardExtensions
    {
        ...
        /// <param name="timing">执行时机</param>
        /// <returns>注册句柄</returns>
        public static int OnPlayerConnect(this PlayerForwardCallback callback, ForwardTiming timing = ForwardTiming.Pre)
        {
