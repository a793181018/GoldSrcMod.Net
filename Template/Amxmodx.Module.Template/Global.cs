...
public unsafe static class Global
{
    ...
    public static delegate* unmanaged[Cdecl]<int, int, void> g_fn_SetPlayerHealth;
    public static delegate* unmanaged[Cdecl]<int, int> g_fn_GetPlayerArmor;
    public static delegate* unmanaged[Cdecl]<int, int, void> g_fn_SetPlayerArmor;
    public static delegate* unmanaged[Cdecl]<int, float, void> g_fn_SetPlayerGravity;
    public static delegate* unmanaged[Cdecl]<int, float, void> g_fn_SetPlayerMaxSpeed;
    public static delegate* unmanaged[Cdecl]<int, int, void> g_fn_SetPlayerRenderMode;
    ...
    public static delegate* unmanaged[Cdecl]<sbyte*, void> g_fn_ServerCommand;
    public static delegate* unmanaged[Cdecl]<int, int> g_fn_GetPlayerCurrentWeapon;
    public static delegate* unmanaged[Cdecl]<int, sbyte*, void> g_fn_GivePlayerItem;
    public static delegate* unmanaged[Cdecl]<float*, float, float, int, void> g_fn_CreateExplosion;
