...
namespace AmxModx.Bridge.Engine
{
    ...
    public static class EngineEventDelegates
    {
        ...
        public static class EngineEventManager
        {
            ...
            private delegate void ImpulseCallback(int client, int impulse);

            [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
            private delegate void TouchCallback(int touched, int toucher);

            [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
            private delegate void ThinkCallback(int entity);
